...
function main() {
  ...
  var compte = [
    ["Vendes netes", r],
    [
      `Variació d'existències de productes acabats <span style='color: green'>${
        V1 ? "F>I" : "I>F"
      }</span>`,
      random(0, 10000),
    ],
    [
      `Variació d'existències de productes en curs <span style='color: green'>${
        V2 ? "F>I" : "I>F"
      }</span>`,
      random(0, 10000),
    ],
  ...
  var toShow = [];
  if (!V1) compte[1][1] = compte[1][1] * -1;
  if (!V2) compte[2][1] = compte[2][1] * -1;
  //
  div.innerHTML = ``; //clear
  toShow.push(`
    <p class='compteEnun'><li>${
      compte[0][0]
    } : <span style='color: red'>${numberWithCommas(
    compte[0][1]
  )}</span></li></p>
    `);
  var showed = [compte[0]];
  ...
  for (let i = 18; i < 20; i++) {
    if (random(0, 1)) {
      toShow.push(
        (div.innerHTML += `<p class='compteEnun'><li>${
          compte[i][0]
        } : <span style='color: red'>${numberWithCommas(
          compte[i][1]
        )}</span></li></p>`)
  ...
  toShow.push(
    `<p class='compteEnun'><li>${
      ...
      compte[20][1]
    )}<a style="text-decoration:none; color:red;" href="./images/ep.jpeg">%</a></span></li></p>`
  );
  ...
  showed.forEach((element) => {
    if (compte.indexOf(element) == 0) {
      document.getElementById("inxn").innerHTML += `<p><li>${
        element[0]
      } : <span style='color: red'>${numberWithCommas(
        element[1]
      )}</span></li></p>`;
      ...
      document.getElementById("vpac").innerHTML += `<p><li>${
        element[0]
      } : <span style='color: red'>${numberWithCommas(
        element[1]
      )}</span></li></p>`;
      ...
      document.getElementById("aie").innerHTML += `<p><li>${
        element[0]
      } : <span style='color: red'>${numberWithCommas(
        element[1]
      )}</span></li></p>`;
      ...
      document.getElementById("provs").innerHTML += `<p><li>${
        element[0]
      } : <span style='color: red'>${numberWithCommas(
        element[1]
      )}</span></li></p>`;
      ...
      document.getElementById("ddp").innerHTML += `<p><li>${
        element[0]
      } : <span style='color: red'>${numberWithCommas(
        element[1]
      )}</span></li></p>`;
      ...
      document.getElementById("adi").innerHTML += `<p><li>${
        element[0]
      } : <span style='color: red'>${numberWithCommas(
        element[1]
      )}</span></li></p>`;
      ...
      [9, 10, 11, 12, 13, 14, 15, 16, 17].includes(compte.indexOf(element))
    ) {
      document.getElementById("ade").innerHTML += `<p><li>${
        element[0]
      } : <span style='color: red'>${numberWithCommas(
        element[1]
      )}</span></li></p>`;
      ...
      document.getElementById("res-ex").innerHTML += `<p><li>${
        element[0]
      } : <span style='color: red'>${numberWithCommas(
        element[1]
      )}</span></li></p>`;
      ...
      document.getElementById("bai").innerHTML += `<p><li id='bentax'>${
        element[0]
      } : <span style='color: red'>${numberWithCommas(
        element[1]
      )} % </span></li></p>`;
  ...
  document.getElementById("res-fin-n").innerHTML = numberWithCommas(
    IngressosFinancers - DespesesFinanceres
  );
  document.getElementById("bai-n").innerHTML = numberWithCommas(
    IE - DE + (IngressosFinancers - DespesesFinanceres)
  ); //baii + rf
  var BAI = IE - DE + (IngressosFinancers - DespesesFinanceres);
  if (BAI > 0) {
    document.getElementById("bentax").innerHTML += `&rarr; ${numberWithCommas(
      parseInt((compte[20][1] / 100) * BAI)
    )}`;
    document.getElementById("ben-n").innerHTML = numberWithCommas(
      BAI - parseInt((compte[20][1] / 100) * BAI)
    ); //baii + rf
  } else {
